const countries = [
    ...
    function initCountrySelect(selectBox) {
        ...
        const inputField = selectBox.querySelector('.selected-option input[type="tel"]');
    
        // Populate the options list with countries and their flags
        ...
        function selectOption(event) {
            ...
            const phoneCode = option.querySelector('strong').innerText;
            const icon = option.querySelector('.iconify').cloneNode(true);
    
            // Update the selected option with the correct flag and phone code
            selectedOption.innerHTML = '';
            selectedOption.append(icon);
            selectedOption.append(document.createTextNode(phoneCode));
            //inputField.value = phoneCode;
    
            // Close the dropdown
            selectBox.querySelector('.options').classList.remove('active');
            selectBox.querySelector('.selected-option').classList.remove('active');
        }
    
        function toggleDropdown() {
            selectBox.querySelector('.options').classList.toggle('active');
            selectBox.querySelector('.selected-option').classList.toggle('active');
        }
        ...
        function searchCountry() {
            ...
            options.forEach(option => {
                ...
                const isMatched = countryName.includes(query);
    ...
    // Initialize each select-box on the page
    document.querySelectorAll('.select-box').forEach(initCountrySelect);